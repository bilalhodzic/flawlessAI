...
export const strings = new LocalizedStrings({
  en: {
    ...
    TeamSinisaIme: `Sinisa Milosevic`,
    TeamSinisaOpis: `Chief Operating Offices`,

    TeamDaliborIme: `Dalibor Vujovic`,
    TeamDaliborOpis: `Chief Executive Officer`,

    TeamEnisIme: `Enis Habul`,
    TeamEnisOpis: `Chief Technology Officer`,

    TeamBilalIme: `Bilal Hodzic`,
